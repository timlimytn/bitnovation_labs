...
import heroImg from "../public/img/web_3d.png";
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Building Future-Ready Software for Your Business
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              At Bitnovate Labs, we specialize in developing robust, scalable,
              and intuitive software solutions that are designed to grow with
              your business. Whether you're looking to streamline processes or
              enhance user experiences, our expert team is here to help you
              achieve your goals with precision and innovation
            </p>
