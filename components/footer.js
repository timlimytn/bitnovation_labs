        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div>
              {" "}
              <Link href="/">
                <span className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100 mb-2">
                  <img
                    src="/bitnovate_logo.png"
                    alt="N"
                    width="32"
                    height="32"
                    className="w-8"
                ...
                <span className="uppercase">Bitnovate Labs</span>
              </Link>
            </div>

            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Empowering businesses with custom software, web, and app
